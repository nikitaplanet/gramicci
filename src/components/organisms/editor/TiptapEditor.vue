<template>
	<div v-if="editorInstance" id="tiptap" class="w-full mx-auto">
		<div id="tiptap-toolbar" class="bg-tool-background sticky top-[96px] left-0">
			...
			<TiptapToolbarGroup>
				<TiptapToolbarButton :isActive="editorInstance?.isActive('link')" @click="openLinkDialog" label="Link">
			...
			<TiptapToolbarGroup v-if="editorInstance?.isActive('table')">
				...
				<TiptapToolbarButton @click="editorInstance?.commands.addColumnBefore()" label="Add column before">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<TiptapToolbarButton @click="editorInstance?.commands.addColumnAfter()" label="Add column after">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<TiptapToolbarButton @click="editorInstance?.commands.deleteColumn()" label="Remove column">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<TiptapToolbarButton @click="editorInstance?.commands.addRowBefore()" label="Add row before">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<TiptapToolbarButton @click="editorInstance?.commands.deleteRow()" label="Remove row">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<TiptapToolbarButton @click="editorInstance?.commands.mergeOrSplit()" label="Merge or split cell">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path
