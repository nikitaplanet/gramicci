const staticWords =
	...
	'\t\t*為避免 GRAMICCI 品牌腰帶扣頭遺失，請勿拆下洗滌，也請使用洗衣袋<br />\n' +
	'\t\t<a href="https://www.gramiccitwshop.com/about/policy" target=“_blank”>\n' +
	'\t\t*購買前請詳閱退換貨政策，確認同意後再進行購買，若對商品有疑問，請在購買前向客服提出。<br />購買前詳盡地溝通，可省下退款/換貨所耗費的心力、金錢與時間。<br />\n' +
	'\t\t</a>\n' +
	'\t</h5>\n' +
	'</div>';
export {staticWords};
